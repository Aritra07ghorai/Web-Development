...
extern int       ShortMaPeriod = 3;
extern int       LongMaPeriod  = 5;
...
int start()
{
   ...
   if(iADX(NULL,PERIOD_H1,250,PRICE_CLOSE,MODE_PLUSDI,0)>iADX(NULL,PERIOD_H1,250,PRICE_CLOSE,MODE_MINUSDI,0)
      && signal == MACROSS_OPEN_BUY_SIGNAL)
      {
         Print("Buy signal");
      ...
      else if (iADX(NULL,PERIOD_H1,250,PRICE_CLOSE,MODE_MINUSDI,0)>iADX(NULL,PERIOD_H1,250,PRICE_CLOSE,MODE_PLUSDI,0)
               && signal == MACROSS_OPEN_SELL_SIGNAL)
      {
         Print("Sell signal");
